...
export default function BannerAreaInvesment() {
  const refBox = useRef()
  ...
  >
    ...
    <div className="absolute w-full h-full z-[4] flex justify-center items-center">
      ...
      >
        <AnimationTextHeader delay={0.2} className="font-bold text-5xl" text={"Area Investasi"} />
        <AnimationTextHeader delay={0.4} className="mt-4 text-3xl" text={"Danantara berinvestasi di sektor-sektor strategis."} />
      </motion.div>
    </div>
