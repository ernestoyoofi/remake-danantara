...
export default function JourneyToProspertiy() {
  ...
  return <div>
    <RevealWrapper origin="bottom" reset={false} distance="260px">
      <div className="w-full h-[calc(100vh-calc(50px*2))] max-h-[940px] min-h-[420px] overflow-hidden px-4" data-group-element="journey_abouting">
        ...
        <div className="w-full h-[calc(100vh-170px)] min-h-[490px] max-h-[950px]">
          <div className="absolute w-[calc(100%-calc(16px*2))] h-[calc(100vh-170px)] min-h-[490px] max-h-[950px] from-transparent to-white bg-gradient-to-br z-20 flex justify-center overflow-hidden">
            <div className="w-full max-w-[1873px] max-h-[calc(950px)] flex justify-end">
              <RevealWrapper className="w-full max-w-[720px] h-[calc(100vh-170px)] min-h-[490px] max-h-[950px] px-10 flex justify-center items-center backdrop-blur-xs" reset={false} origin="left">
    ...
    <RevealWrapper origin="bottom" reset={false} distance="70px">
      <div className="w-full h-[calc(100vh-calc(50px*2))] max-h-[940px] min-h-[420px] overflow-hidden px-4 mt-3 max-w-[1873px] m-auto max-xl:max-w-max max-xl:min-h-min">
        <div className="w-full h-[calc(100vh-350px)] min-h-[490px] max-h-[710px] flex items-center max-xl:flex-col max-xl:max-w-max max-xl:min-h-min">
          <div className="w-[520px] max-xl:w-full h-full flex items-end justify-end max-xl:object-bottom max-md:h-[470px]">
            <img
              alt="Building flag indonesia"
              className="w-full h-full object-cover"
